...
public class PluginFile {
	 ...
	 * has a default resource, set the FileConfiguration defaults to the YamlConfiguration of the default resource.
	 */
	...
	public void saveConfig() {
		if (fileConfig != null && configFile != null) {
			try {
				plugin.getLogger().info("Save file: " + configFile.getName());
