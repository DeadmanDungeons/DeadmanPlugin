 ...
 * The loaded values of a ConfigEnum can be obtained with the {@link #getValue(Enum)} and {@link #getList(Enum)} methods.
 * A Converter will need to be registered for config values that are of a type other than String, Integer, Boolean,
 * ChatColor, or ItemStack. Use {@link #registerConverter(Class, Converter)} to register a new Converter, or to override
 * a default converter.
 * @author Jon
 */
public class DeadmanConfig {
	...
	private static final String NON_LOADED_ENUM = "The values for the '%s' ConfigEnum has not been loaded!";
